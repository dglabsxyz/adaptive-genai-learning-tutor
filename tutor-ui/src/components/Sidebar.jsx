...
export default function Sidebar({ onToggleHelp, open = false, onClose }) {
  ...
  return (
    <>
      ...
      <aside
        className={`w-[260px] h-full flex flex-col border-r border-[var(--border)] flex-shrink-0 glass-sidebar
